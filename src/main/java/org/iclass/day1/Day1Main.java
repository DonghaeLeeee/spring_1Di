...
public class Day1Main {
	...
	public static void main(String[] args) {
		...
		System.out.println("::::setter 메소드로 의존관계를 설정::::");
		//1)dao객체를 service 가 사용하게 합시다. : 방법1)setter 메소드로 전달하기 2)생성자로 전달하기
		...
		System.out.println("::::커스텀 메소드로 의존관계를 설정::::");
...
//스프링에서는 1),2)에 해당하는 의존객체 설정을 자동으로 합니다. 1)생성자 주입(커스텀생성자) 2)setter 주입
}
